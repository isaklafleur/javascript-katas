...
// =====================================================
// for loop can traverse the array
// for..in, can traverse all the keys of the object
// for..in can also be used in arrays, at this time the array is treated as an object
// Although for..in can traverse the array, but we do not recommend the use of it.
// for..of(New member of ES6), it can traverse all the values of the array, if you don't care about its index
// =====================================================


//if the length of the object key equals to 5, then push the key value to the array
//push the value to the array as well, if the length of the value is equal to 5

function giveMeFive(obj){
    var array = [];
    for(var key in obj) {
        //check if value length is equal to 5
