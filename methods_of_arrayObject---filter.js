...
let countGrade = scores => {
    return {
        S:scores.filter(grades.S).length,
        A:scores.filter(grades.A).length,
        B:scores.filter(grades.B).length,
        C:scores.filter(grades.C).length,
        D:scores.filter(grades.D).length,
        X:scores.filter(grades.X).length
    }
}

//////////////////////////////////////
var countGrade = scores => ({
